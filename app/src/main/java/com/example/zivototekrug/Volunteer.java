...
public class Volunteer extends AppCompatActivity implements View.OnClickListener {
    ...
    private void CreateList() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Volunteer.this, "Настана грешка.Обидете се повторно!", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private float PresmetajRastojanie(LatLng start, LatLng end) {
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Volunteer.this, "Unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.site:
                startActivity(new Intent(this, Volunteer_activities.class));
                break;
        }
    }
}